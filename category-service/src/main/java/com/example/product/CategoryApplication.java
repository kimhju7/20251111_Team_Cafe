...
public class CategoryApplication {
    ...
    @Bean
    public Queue categoryServicePostQueue() {
        return new Queue("category-service.post-events", true);
    }

    @Bean
    public Binding bindPostEventsToCategoryServiceCreated() {
        return BindingBuilder.bind(categoryServicePostQueue())
                .to(blogEventsExchange())
                .with("post.created");
    }

    @Bean
    public Binding bindPostEventsToCategoryServiceDeleted() {
        return BindingBuilder.bind(categoryServicePostQueue())
                .to(blogEventsExchange())
                .with("post.deleted");
    }
